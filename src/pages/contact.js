        ...
        <Layout>
            <div className={`wrapper ${styles.wrapper}`}>
                <form className={`form ${styles.form}`} name="contact" method="post" data-netlify="true" data-netlify-honeypot="bot-field" action="/success">
                    ...
                    <input type="text" htmlFor="name" className={`name ${styles.name} ${styles.formEntry}`} placeholder="Name" />
                    <input type="text" htmlFor="email" className={`email ${styles.email} ${styles.formEntry}`} placeholder="Email"/>
                    <textarea className={`message ${styles.message} ${styles.formEntry}`} placeholder="Message"></textarea>
